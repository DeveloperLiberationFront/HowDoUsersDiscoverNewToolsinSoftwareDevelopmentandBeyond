...
\journalname{Computer Supported Cooperative Work}
...
\institute{Emerson Murphy-Hill and Da Young Lee\at
              ...
              \email{\{emerson,dlee10\}@csc.ncsu.edu}           %  \\
           \and
...
% Constructionist learning~\citep{papert}, where a person learns by
...
the common ones being python~\citeyearpar{python}, javascript~\citep{javascript}, PHP~\citeyearpar{php}, 
...
\begin{table}[t]
    ...
    %\begin{tabularx}{\linewidth}{Xr|ccc|cc}	    
		...
		\textbf{Pseudonym}&\textbf{experience}&\textbf{team}&\textbf{blogs}&
...
situations, consistent with other researchers' observations~\citep{cockburn00}, 
...
system''~\citep{mcgrenere2002design}.
...
discovery.
Of the 156 tool discovery reports submitted, 45 of them met this criterion.

\subsubsection{Results}\label{sec:diaryresults}  
...
% 	\includegraphics[width=\columnwidth]{effectiveness.eps}
 	...
 	\end{center}
 	\vspace{-5 mm}
 	\caption{Histogram of the most effective discovery modes estimated by participants 
 	in the diary study (n=50 participants, 2 modes per participant).}\label{fig:effectivemode}
 \end{figure}
...
Figure~\ref{fig:effectivemode} shows a histogram that
displays the top two highest ranked discovery modes for each participant.
For example, the figure shows that in total 11 people reported
that written descriptions were one of their top two 
most effective ways that they learned about new tools.
...
% forgets what mode she is in~\citep{raskin}.
% 
...
\paraHead{Trust.} Interviewees' high valuation of trust (Section~\ref{sec:interviewresults})
...
% textual recommendations~\citep{apple}, suggests that this approach will not be
...
\newblock {\em Journal of Information Systems}, 
 vol. 17, no. 1, Spring 2003, pp. 107--134.

\bibitem[Brooke, 2009]{brooke}
Brooke, Libby (2009).
\newblock Prolonging the careers of older information technology workers:
  continuity, exit or retirement transitions?
\newblock {\em Ageing \& Society}, 
 vol. 29, no. 2, February 2009, pp. 237--256.

\bibitem[Campbell and Miller, 2008]{campbell08}
Campbell, Dustin and Mark Miller (2008).
\newblock Designing refactoring tools for developers.
\newblock In D. Dig, R. Fuhrer and R. Johnson (eds): {\em WRT'09. Proceedings of the 2nd Workshop on Refactoring Tools, Nashville, US, 19 October, 2008}, 
 New York: ACM Press, pp. 1--2.

\bibitem[Cockburn and Williams, 2000]{cockburn00}
Cockburn, Alistair, and Laurie Williams. (2000).
\newblock The costs and benefits of pair programming.
\newblock In {\em Proceedings of the Conference on Extreme Programming, Cagliari, Italy, 21 June--23 June, 2000}, 
pages
 Boston: Addison-Wesley, pp. 223--247.

\bibitem[Crook, 1991]{crook}
Crook, Charles (1991).
\newblock Computers in the zone of proximal development: Implications for
  evaluation.
\newblock {\em Computers {\&} Education}, 
 vol. 17, no. 1, pp. 81 -- 91.

\bibitem[Davis, 1989]{DAVI89}
Davis, Fred D. (1989).
\newblock Perceived usefulness, perceived ease of use, and user acceptance of
  information technology.
\newblock {\em MIS Quarterly}, 
 vol. 13, no. 3, September 1989, pp. 319--340.

\bibitem[Fichman and Kemerer, 1999]{fichman99}
Fichman, Robert G., and Chris F. Kemerer (1999).
\newblock The illusory diffusion of innovation: An examination of assimilation
  gaps.
\newblock {\em Information Systems Research}, 
vol. 10, no. 3, September 1999, pp. 255--275.

\bibitem[Findlater et~al., 2008]{findlater08}
Findlater, Leah, Joanna McGrenere, and David Modjeska (2008).
\newblock Evaluation of a role-based approach for customizing a complex
  development environment.
\newblock In D. Tan (ed): {\em CHI'08: Proceedings of the Twenty-Sixth Annual SIGCHI Conference on
  Human Factors in Computing Systems, Florence, Italy, 5 April--10 April, 2008}. 
  New York: ACM Press, pp. 1267--1270.

\bibitem[Fischer et~al., 1984]{fischer84}
Fischer, Gerhard, Andreas Lemke, and Thomas Schwab (1984).
\newblock Active help systems.
\newblock In G. C. van der Veer, M. J. Tauber, T. R. G. Green, P. and Gorny (eds):
{\em Readings on Cognitive Ergonomics -- Mind and Computers}, 
Berlin: Springer-Verlag, pp. 115--131.

\bibitem[Flanagan, 2006]{javascript}
Flanagan, David (2006).
\newblock {\em JavaScript: the definitive guide}.
\newblock Newton: O'Reilly Media, Incorporated.

\bibitem[Flanagan, 1954]{flanagan1954critical}
Flanagan, John C. (1954).
\newblock The critical incident technique.
\newblock {\em Psychological Bulletin}, 
 vol. 51, no. 4, pp. 327--358.

\bibitem[Fleiss et~al., 1981]{fleiss1981measurement}
...
\bibitem[Glaser and Strauss, 2009]{glaser2009discovery}
Glaser, Barney G., and Anselm L. Strauss (2009).
\newblock {\em The discovery of grounded theory: Strategies for qualitative
  research}.
\newblock Alexandria: Transaction Books.

\bibitem[Grossman et~al., 2009]{grossman09}
Grossman, Tovi, George Fitzmaurice, and Ramtin Attar (2009).
\newblock A survey of software learnability: metrics, methodologies and
  guidelines.
\newblock In K. Hinckley, M. R. Morris, S. Hudson, S. Greenberg (eds): {\em CHI'99. Proceedings of the Twenty-Seventh Annual SIGCHI Conference on
  Human Factors in Computing Systems, Boston, US, 4 April--9 April}, 
  New York: ACM Press, pp. 649--658.

\bibitem[Huttenlocher et~al., 1990]{huttenlocher1990reports}
Huttenlocher, Janellen, Larry V. Hedges, and Norman M. Bradburn. (1990).
...
\newblock {\em Journal of Experimental Psychology: Learning, Memory, and
  Cognition}, 
  vol. 16, no. 2, March 1990, pp. 196--213.

\bibitem[Iivari, 1996]{iivari}
Iivari, Juhani (1996).
\newblock Why are {CASE} tools not used?
\newblock {\em Communications of the ACM}, 
  vol. 39, no. 10, October 1996, pp. 94--103.

\bibitem[Landis and Koch, 1977]{landis77}
...
\newblock {\em Biometrics}, 
 vol. 33, no. 1, March 1977, pp. 159--174.

\bibitem[Lave and Wenger, 1991]{lave}
Lave, Jean, and Etienne Wenger (1991).
\newblock {\em Situated Learning: Legitimate Peripheral Participation}.
\newblock Cambridge: Cambridge University Press, 1st edition.

\bibitem[Linton et~al., 2000]{linton}
Linton, Frank, Deborah Joy, Hans-Peter Schaefer, and Andrew Charron (2000).
\newblock {OWL: A recommender system for organization-wide learning}.
\newblock {\em Educational Technology \& Society}, 
 vol. 3, no. 1, January 2000, pp. 62--76.

\bibitem[Luckin, 2001]{luckin}
Luckin, Rosemary (2001).
...
\newblock {\em Information Technology in Childhood Education}, 
 vol. 2001, no. 1, pp. 57--85.

\bibitem[Maltzahn, 1995]{maltzahn}
Maltzahn, Carlos (1995).
\newblock Community help: discovering tools and locating experts in a dynamic
  environment.
\newblock In I. Katz, I. Mack, L. Marks (eds): {\em CHI'95: Proceedings of the SIGCHI Conference on Human Factors in
  Computing Systems, Denver, US, 14 April--18 April, 1996}, 
New York: ACM Press, pp. 260--261.

\bibitem[Marsick and Watkins, 2001]{marsick01}
Marsick, Victoria J., and Karen E. Watkins (2001).
\newblock Informal and incidental learning.
\newblock {\em New Directions for Adult and Continuing Education}, 
 vol. 2001, no. 89, Spring 2001, pp. 25--34.

\bibitem[Matejka et~al., 2009]{matejka09}
Matejka, Justin, Wei Li, Tovi Grossman, and George Fitzmaurice (2009).
\newblock {CommunityCommands}: command recommendations for software
  applications.
\newblock In F. Guimbretière (ed): {\em UIST'09: Proceedings of the Symposium on User Interface Software and
  Technology, Victoria, Canada, 4 October--7 October, 2009}. 
  New York: ACM Press, pp. 193--202.

\bibitem[McGrenere, 2002]{mcgrenere2002design}
McGrenere, Joanna (2002).
\newblock {\em {The Design and Evaluation of Multiple Interfaces: A Solution
  for Complex Software}}.
\newblock Ph.D. dissertatino. University of Toronto, Ontario: Department of Computer Science.

\bibitem[Moore and Benbasat, 1991]{MOOR91}
Moore, Gary C. and Izak Benbasat (1991).
\newblock {Development of an Instrument to Measure the Perceptions of Adopting
  an Information Technology Innovation}.
\newblock {\em Information Systems Research}, 
 vol. 2, no. 3, September 1991, pp. 192--222.

\bibitem[Morrison and Murphy-Hill, 2013]{morrison}
Morrison, Patrick, and Emerson Murphy-Hill (2013).
\newblock Is programming knowledge related to age? {An} exploration of
  {StackOverflow}.
\newblock In A. Bacchelli (ed): {\em MSR'13. Proceedings of the 10th Working Conference on Mining Software
  Repositories, Challenge Track, San Francisco, US, 18 May--19 May, 2013}. 
  Los Alamitos: IEEE Press, pp. 69--72.

\bibitem[M\"{u}ller and Tichy, 2001]{muller}
M\"{u}ller, Matthias M. and Tichy, Walter F. (2001).
\newblock Case study: Extreme programming in a university environment.
\newblock In M. J. Harrold and W. Schafer: {\em ICSE'01. Proceedings of the 23rd International Conference on Software
  Engineering, Toronoto, Canada, 12 May--19 May, 2001}. 
  Los Alamitos: IEEE Press, pp. 537--544.

\bibitem[Murphy-Hill, 2012]{murphyHill12b}
Murphy-Hill, Emerson (2012).
\newblock Continuous social screencasting to facilitate software tool
  discovery.
\newblock In A. Bertolino and A. Wolf: {\em ICSE'12. Proceedings of the 34th International Conference on Software
  Engineering, 2 June--9 June, 2012}. 
  Los Alamitos: IEEE Press, pp. 1317--1320.

\bibitem[Murphy-Hill et~al., 2012]{murphyHill12c}
Murphy-Hill, Emerson, Rahul Jiresal, and Gail C. Murphy (2012).
\newblock Improving software developers' fluency by recommending development
  environment commands.
\newblock In M. Robillard and T. Bultan: {\em FSE'12. Proceedings of the 20th ACM SIGSOFT Symposium on the
  Foundations of Software Engineering, Cary, North Carolina, 11 November--16 November 2012}, 
  New York: ACM Press, pp. 1--11.

\bibitem[Murphy-Hill et~al., 2015]{appendix}
Murphy-Hill, Emerson, Da Young Lee, , Gail C. Murphy, and Joanna McGrenere (2015).
...
\bibitem[Murphy-Hill and Murphy, 2011]{murphy-hill11:peer}
Murphy-Hill, Emerson and Gail C. Murphy. (2011).
\newblock Peer interaction effectively, yet infrequently, enables programmers
  to discover new tools.
\newblock In J. Bardram and N. Ducheneaut (eds): {\em CSCW'11. Proceedings of the 
Conference on Computer Supported
  Cooperative Work, Hangzhou, China, 19 March--23 March 2011}, New York: ACM Press, pp. 405--414.

\bibitem[Nielsen, 1993]{nielsenBook}
Nielsen, Jacob (1993).
\newblock {\em Usability Engineering}.
\newblock San Francisco: Morgan Kaufmann Publishers Inc.

\bibitem[Rieman, 1996]{rieman}
Rieman, John (1996).
\newblock A field study of exploratory learning strategies.
\newblock {\em Transactions on Computer-Human Interaction}, 
 vol. 3, no. 3, September 1996, pp. 189--218.

\bibitem[Rogers, 2003]{rogers03}
Rogers, Everett~M. (2003).
\newblock {\em Diffusion of Innovations}.
\newblock Free Press, 5th edition.

\bibitem[Thompson et~al., 1991]{THOM91}
Thompson, Ronald L., Christopher A. Higgins, and Jane M. Howell (1991).
\newblock {Personal Computing: Toward a Conceptual Model of Utilization}.
\newblock {\em MIS Quarterly}, 
 vol. 15, no. 1, March 1991, pp. 125--143.

\bibitem[Twidale, 2005]{twidale05}
Twidale, Michael B. (2005).
\newblock Over the shoulder learning: Supporting brief informal learning.
\newblock {\em Computer Supported Cooperative Work}, 
 vol. 14, no. 6, December 2005, pp. 505--547.


\bibitem[Venkatesh and Davis, 2000]{VENK00}
...
\bibitem[Vygotsky, 1978]{vygotsky}
Vygotsky, Lev S. (1978).
\newblock {\em {Mind in Society: Development of Higher Psychological
  Processes}}.
\newblock Cambridge: Harvard University Press.

\bibitem[Xiao et~al., 2014]{xiao}
Xiao, Shundan, Jim Witschey, and Emerson Murphy-Hill (2014).
\newblock Social influences on secure development tool adoption: Why security
  tools spread.
\newblock In M. R. Morris and M. Reddy (eds): {\em CSCW'14. Proceedings of Computer Supported Cooperative Work and Social Computing, Baltimore, Maryland, 15 February--19 February 2015}. New York: ACM Press, pp. 1095-1106.
...
\bibitem[Eclipse, 2012]{eclipse}
Eclipse (2012).
\newblock Eclipse IDE.
\newblock \url{http://www.eclipse.org}.

\bibitem[Emacs, 2012]{emacs}
Emacs (2012).
\newblock emacs.
\newblock \url{http://www.gnu.org/software/emacs/}.

\bibitem[Firefox, 2012]{firefox}
Firefox (2012).
\newblock {Mozilla Firefox}.
\newblock \url{www.mozilla.org/en-US/firefox}.

\bibitem[Java, 2012]{java}
Java (2012).
\newblock {Java}.
\newblock \url{http://java.net}.

\bibitem[{NetBeans}, 2012]{netbeans}
{NetBeans} (2012).
\newblock {NetBeans IDE}.
\newblock \url{http://netbeans.org/}.

\bibitem[Perl, 2012]{perl}
Perl (2012).
\newblock {Perl}.
\newblock \url{http://www.perl.org/}.

\bibitem[PHP, 2012]{php}
PHP (2012).
\newblock {PHP}.
\newblock \url{http://www.php.net/}.

\bibitem[Python, 2012]{python}
Python (2012).
\newblock {Python}.
\newblock \url{http://python.org/}.

\bibitem[Ruby, 2012]{ruby}
Ruby (2012).
\newblock {Ruby}.
\newblock \url{http://www.ruby-lang.org}.

\bibitem[{TextMate}, 2012]{textmate}
{TextMate} (2012).
\newblock {TextMate}.
\newblock \url{http://macromates.com}.

\bibitem[Twitter, 2012]{twitter}
Twitter (2012).
\newblock {Twitter}.
\newblock \url{https://twitter.com/}.

\bibitem[Vim, 2012]{vim}
Vim (2012).
\newblock vim.
\newblock \url{http://www.vim.org}.

\bibitem[Visual Studio, 2012]{visualstudio}
Visual Studio (2012).
\newblock {Visual Studio}.
\newblock \url{http://msdn.microsoft.com/vstudio}.

\bibitem[Word, 2012]{word}
Word (2012).
\newblock {Mirosoft Word}.
