...
As Fisher and colleagues point out, these technical solutions ``should guide
...
One related theory is Lave and Wegner's situated learning~\cite{lave}, where the learning
...
made with little trepidation, during \discpush 
...
tend teach and learn via peer interaction less than junior programmers (Table~\ref{tbl:social}).
...
\Discovery may be even rarer than we though after conducting the interview study; 
even though 
...
implications for the design or recommender systems,
